...
local PostPickupInit = require("sewn_scripts.callbacks.vanilla.post_pickup_init")
local PostPickupUpdate = require("sewn_scripts.callbacks.vanilla.post_pickup_update")
local PrePickupCollision = require("sewn_scripts.callbacks.vanilla.pre_pickup_collision")
local PostBombUpdate = require("sewn_scripts.callbacks.vanilla.post_bomb_update")
...
SewnMod:AddCallback(ModCallbacks.MC_POST_PICKUP_INIT, PostPickupInit)
SewnMod:AddCallback(ModCallbacks.MC_POST_PICKUP_UPDATE, PostPickupUpdate)
SewnMod:AddCallback(ModCallbacks.MC_PRE_PICKUP_COLLISION, PrePickupCollision)
SewnMod:AddCallback(ModCallbacks.MC_POST_BOMB_UPDATE, PostBombUpdate)
-- Familiar related callbacks
...
require("sewn_scripts.items.pickups")
